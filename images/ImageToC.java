...
// exports png images into src/gui/lib/images.hpp

public class ImageToC {
    public static void main(String[] args) throws Exception {
        OutputStream images_h = new FileOutputStream("../src/gui/lib/images.hpp");
        OutputStream icons_h = new FileOutputStream("../src/gui/lib/icons.hpp");
        OutputStream icons_cpp = new FileOutputStream("../src/gui/lib/icons.cpp");
        OutputStream cursors_h = new FileOutputStream("../src/gui/lib/cursors.hpp");
        ...
        icons_h.write(("#ifndef Icons_H\n#define Icons_H\n\n#include <SDL2/SDL.hpp>" + header).getBytes());
        cursors_h.write(("#ifndef Cursors_H\n#define Cursors_H\n\n#include <SDL2/SDL.hpp>" + header).getBytes());
        icons_cpp.write(("#include \"icons.hpp\"\n#include \"images.hpp\"" + header).getBytes());
        cursors_cpp.write(("#include \"cursors.hpp\"\n#include \"images.hpp\"" + header).getBytes());
