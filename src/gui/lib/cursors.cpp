...
void init_cursors() {
    ...
    cursor_clip_left = SDL_CreateColorCursor(CreateSdlSurfaceFromPng(icon_cursor_clip_left_data), 8, 8);
    cursor_clip_right = SDL_CreateColorCursor(CreateSdlSurfaceFromPng(icon_cursor_clip_right_data), 8, 8);
}
